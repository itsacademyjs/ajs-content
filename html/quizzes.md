...
```html
<form method="post" action="mailto:info@academyjs.com" ____="text/plain"></form>
```
...
```html
<base href="http://www.academyjs.com/dir/" />
```

- [x] `http://www.academyjs.com/dir/page.html`
- [ ] `page.html`
- [ ] `http://www.academyjs.com/page.html`
- [ ] `dir/page.html`
...
<address>
  ...
  <a href="mailto:info@academyjs.com">info@academyjs.com</a>
</address>
```
